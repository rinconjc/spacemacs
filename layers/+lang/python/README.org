...
|---------------+-------------------------------------------------|
| ~SPC m V v a~ | activate a virtual environment in any directory |
| ~SPC m V v d~ | deactivate active virtual environment           |
| ~SPC m V v w~ | work on virtual environment in =WORKON_HOME=    |
...
| Key binding   | Description                          |
|---------------+--------------------------------------|
| ~SPC m V e s~ | set a pyenv environment with [[https://github.com/pyenv/pyenv][pyenv]]   |
| ~SPC m V e u~ | unset a pyenv environment with [[https://github.com/pyenv/pyenv][pyenv]] |
...
| Key binding   | Description                                                         |
|---------------+---------------------------------------------------------------------|
| ~SPC m V P d~ | De-activate the virtualenv associated to the current poetry project |
| ~SPC m V P a~ | Activate the virtualenv associated to the current poetry project    |
| ~SPC m V P t~ | Toggle the virtualenv associated to the current poetry project      |
...
| ~SPC m S s~              | toggle [[https://github.com/naiquevin/sphinx-doc.el][sphinx-doc]] minor mode                                                      |
